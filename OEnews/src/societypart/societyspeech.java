...
public class societyspeech {
	...
	int sc[][] = new int[5][20];  //sd에 구분된 번호의 언론사가 몇번씩 중복돼있는지 알게 해주는 배열
	 ...
	 public societyspeech(){
	BufferedReader br = null;
	try{
		br = Files.newBufferedReader(Paths.get("Rdata/SOCIETYwordspeech.csv")); //csv파일을 읽음  
	 ...
	 String getname(int word, int speech){  //언론사 버튼에 들어갈 텍스트를 리턴하는 함수
		 int find=0;
