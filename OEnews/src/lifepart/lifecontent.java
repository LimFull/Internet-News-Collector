...
public lifecontent(){
	...
	word1.setText(lifek.getwords(0)); word2.setText(lifek.getwords(1));
	word3.setText(lifek.getwords(2)); word4.setText(lifek.getwords(3));
...
class panel extends JPanel
{
	...
	ImageIcon cloudimg = new ImageIcon("cloudlife.png");
