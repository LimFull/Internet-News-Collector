...
public economycontent(){
	...
	ActionListener listener = new ActionListener(){
		public void actionPerformed(ActionEvent e){
			...
			if (e.getActionCommand().equals(ACTION_SPEECH_ONE)){
				int a[] = new int[20];
				economytitle economyt = new economytitle(word, economys.gettitlenumber(word, 0));
			}
 ...
 /*
	for (int i =0; i<economys.sclength[0]; i++){
		JButton buttons = new JButton(economys.getname(0, i));
