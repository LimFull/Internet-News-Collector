...
public politicscontent(){
	...
	ActionListener listener = new ActionListener(){
		public void actionPerformed(ActionEvent e){
			...
			if (e.getActionCommand().equals(ACTION_COMMAND_ONE)){
				...
				int i=0; 
				word = 0;
				while(i<politicss.sclength[0]){
					sb[i].setVisible(true);
					sb[i].setText(politicss.getname(0, i));
					i++;
					if (i==7) break;
				}
				while(i<7){
			...
			if (e.getActionCommand().equals(ACTION_COMMAND_TWO)){
				...
				int i=0; 
				word = 1;
				while(i<politicss.sclength[1]){
					sb[i].setVisible(true);
					sb[i].setText(politicss.getname(1, i));
					i++;
					if (i==7) break;
				}
				while(i<7){
			...
			if (e.getActionCommand().equals(ACTION_COMMAND_THREE)){
				...
				int i=0; 
				word = 2;
				while(i<politicss.sclength[2]){
					sb[i].setVisible(true);
					sb[i].setText(politicss.getname(2, i));
					i++;
					if (i==7) break;
				}
				while(i<7){
			...
			if (e.getActionCommand().equals(ACTION_COMMAND_FOUR)){
				...
				int i=0; 
				word = 3;
				while(i<politicss.sclength[3]){
					sb[i].setVisible(true);
					sb[i].setText(politicss.getname(3, i));
					i++;
					if (i==7) break;
				}
				while(i<7){
			...
			if (e.getActionCommand().equals(ACTION_COMMAND_FIVE)){
				...
				int i=0; 
				word = 4;
				while(i<politicss.sclength[4]){
					sb[i].setVisible(true);
					sb[i].setText(politicss.getname(4, i));
					i++;
					if (i==7) break;
				}
				while(i<7){
			...
			if (e.getActionCommand().equals(ACTION_SPEECH_TWO)){
				int a[] = new int[20];
				politicstitle politicst = new politicstitle(word, politicss.gettitlenumber(word, 1));
			}
			if (e.getActionCommand().equals(ACTION_SPEECH_THREE)){
				int a[] = new int[20];
				politicstitle politicst = new politicstitle(word, politicss.gettitlenumber(word, 2));
			}
			if (e.getActionCommand().equals(ACTION_SPEECH_FOUR)){
				int a[] = new int[20];
				politicstitle politicst = new politicstitle(word, politicss.gettitlenumber(word, 3));
			}
			if (e.getActionCommand().equals(ACTION_SPEECH_FIVE)){
				int a[] = new int[20];
				politicstitle politicst = new politicstitle(word, politicss.gettitlenumber(word, 4));
			}
			if (e.getActionCommand().equals(ACTION_SPEECH_SIX)){
				int a[] = new int[20];
				politicstitle politicst = new politicstitle(word, politicss.gettitlenumber(word, 5));
			}
			if (e.getActionCommand().equals(ACTION_SPEECH_SEVEN)){
				int a[] = new int[20];
				politicstitle politicst = new politicstitle(word, politicss.gettitlenumber(word, 6));
			}
			}
	};
 ...
 /*
	for (int i =0; i<politicss.sclength[0]; i++){
		JButton buttons = new JButton(politicss.getname(0, i));
