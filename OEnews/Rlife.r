...
# 불필요한 글자 제거
 ...
 doc <- TermDocumentMatrix(doc,control=list(tokenize=words,removeNumbers=T,removePunctuation=T,wordLengths=c(3,Inf),
                                            stopwords=c("대한","전","또는","밝혔다","등의","오는","이번","에서","중","당시","그런데","매우","없었다","있었다","또","∼","▲","월","위한","도","했다","게","오전","오후","쓴","옮김","제공","그가","그의","그","그는","거의","것이","것이다","더","자신의","할","로","많","한다","때","있","은","는","이","가","의","위해","것","고","com","있다","및","을","를","수","일","등을","등","▶","통해","바로가기","것으로","년","있는","지난","말했다","이를","한","flash")))
