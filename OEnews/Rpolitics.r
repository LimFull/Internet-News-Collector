...
stopwords=c("이어","오전","오후","","며","월","많","당","전","이날","대해","한다","때","있","은","는","이","가","의","위해","것",">고","com","있다","photo","및","을","▲","를","수","일","등을","등","newsis","뉴시
...
으로","년","있는","지난","말했다","이를","한","기자","또","고","", "flash")))
 ...
 wordtitle <- matrix(nrow=3, ncol=20)      #핫 키워드가 있는 기사의 제목 담을 행렬 생성
